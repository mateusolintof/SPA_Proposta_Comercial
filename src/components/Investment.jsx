            ...
            <div className="container">
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div className="glass-panel" style={{ padding: 'clamp(2rem, 4vw, 3rem)', textAlign: 'center', border: '1px solid var(--color-primary-glow)', boxShadow: '0 10px 40px -10px var(--color-primary-glow)', maxWidth: '440px', width: '100%' }}>
                        ...
                        <div style={{ fontSize: 'clamp(2.5rem, 5vw, 3.5rem)', fontWeight: 800, color: 'var(--color-text)', marginBottom: '0.35rem' }}>R$ 5k</div>
                        <div style={{ color: 'var(--color-text-muted)', marginBottom: '1.5rem' }}>Desenvolvimento e Implementação</div>

                        <div style={{ height: '1px', background: 'var(--color-border)', margin: '1.5rem 0' }} />

                        <div style={{ marginBottom: '1.5rem' }}>
                            <div style={{ fontSize: '1.35rem', fontWeight: 700, color: 'var(--color-text)' }}>+ R$ 2.000<span style={{ fontSize: '1rem', fontWeight: 400, color: 'var(--color-text-muted)' }}>/mês</span></div>
                        ...
                        <p style={{ fontSize: '0.8rem', marginTop: '1rem', color: 'var(--color-text-muted)' }}>
                            3x no cartão de crédito ou 50% a vista e 50% na entrega.
                        </p>
                    </div>
                </div>
            </div>
